 ...
 * @author Andrej Halaj
 */
public class ValidationController extends PC4NBController {

    public ValidationController(PC4NBModel model, AbstractPC4NBVisualPanel wizardView) {
        super(model, wizardView);
    }

    @Override
    public void propertyChange(PropertyChangeEvent evt) {
        if (evt.getPropertyName().startsWith("validation-")) {
