 ...
 * @author Andrej Halaj
 */
public class SenderController extends PC4NBController {

    public SenderController(PC4NBModel model, AbstractPC4NBVisualPanel wizardView) {
        super(model, wizardView);
    }

    @Override
    public void propertyChange(PropertyChangeEvent evt) {
        if (evt.getPropertyName().startsWith("sender-")) {
