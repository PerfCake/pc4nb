 ...
 * @author Andrej Halaj
 */
public class ScenarioController extends PC4NBController {

    public ScenarioController(PC4NBModel model, AbstractPC4NBVisualPanel wizardView) {
        super(model, wizardView);
    }

    @Override
    public void propertyChange(PropertyChangeEvent evt) {
        if (evt.getPropertyName().startsWith("scenario")) {
