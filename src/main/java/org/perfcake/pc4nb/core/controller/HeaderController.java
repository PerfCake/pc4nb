 ...
 * @author Andrej Halaj
 */
public class HeaderController extends PC4NBController {

    public HeaderController(PC4NBModel model, AbstractPC4NBVisualPanel wizardView) {
        super(model, wizardView);
    }

    @Override
    public void propertyChange(PropertyChangeEvent evt) {
        if (evt.getPropertyName().startsWith("header-")) {
