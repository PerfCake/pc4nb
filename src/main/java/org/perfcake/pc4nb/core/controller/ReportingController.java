 ...
 * @author Andrej Halaj
 */
public class ReportingController extends PC4NBController {

    public ReportingController(PC4NBModel model, AbstractPC4NBVisualPanel wizardView) {
