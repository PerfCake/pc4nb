 ...
 * @author Andrej Halaj
 */
public class MessagesController extends PC4NBController {

    public MessagesController(PC4NBModel model, AbstractPC4NBVisualPanel wizardView) {
        super(model, wizardView);
    }

    @Override
    public void propertyChange(PropertyChangeEvent evt) {
        if (evt.getPropertyName().startsWith("messages-")) {
