 ...
 * @author Andrej Halaj
 */
public class PeriodController extends PC4NBController{

    public PeriodController(PC4NBModel model, AbstractPC4NBVisualPanel wizardView) {
        super(model, wizardView);
    }

    @Override
    public void propertyChange(PropertyChangeEvent evt) {
        if (evt.getPropertyName().startsWith("period-")) {
