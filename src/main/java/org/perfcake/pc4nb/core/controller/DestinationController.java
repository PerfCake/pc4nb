 ...
 * @author Andrej Halaj
 */
public class DestinationController extends PC4NBController {

    public DestinationController(PC4NBModel model, AbstractPC4NBVisualPanel wizardView) {
        super(model, wizardView);
    }

    @Override
    public void propertyChange(PropertyChangeEvent evt) {
        if (evt.getPropertyName().startsWith("destination-")) {
