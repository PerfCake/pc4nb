...
import org.perfcake.pc4nb.ui.wizards.visuals.ReporterVisualPanel;
...
public class ReporterWizardPanel implements WizardDescriptor.Panel<WizardDescriptor> {
     ...
     */
    private ReporterVisualPanel component;
    ...
    @Override
    public ReporterVisualPanel getComponent() {
        if (component == null) {
            component = new ReporterVisualPanel();
        }
        return component;
    }
